...
window.landing = new vue__WEBPACK_IMPORTED_MODULE_2__.default({
    ...
    methods: {
        ...
        submitFeedback: function (e) {
            ...
            this.http.post('/feedback/send', formData)
                .then(() => {
                    this.$notify({
                        group: 'foo',
                        duration: 5000,
                        title: 'Вопрос',
                        text: obj.feedback.name + ' мы получили ваш вопрос. Вы получите ответ на ваш email'
                    });
                });
        },
        ...
        subscribeToNews: function () {
            ...
            this.http.post('/Subscribe', formData)
                .then(result => {
                ...
                .catch(error => {
                    this.$notify({
                        ...
                        type: 'error',
                        title: 'Ошибка',
                        text: 'При обработке запроса произошла ошибка. Пожалуйста попробуйте снова или повторите попытку позже.'
                    });
                });
        }
    }
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./js/pages/landing.js");
